...
#ifdef __cplusplus
class Pkcs7PaddingIO : public IODevice {
    IODevice *d;
...
public:
    Pkcs7PaddingIO() : d(NULL) {}
    Pkcs7PaddingIO(IODevice &device, size_t block_size, const char *mode = "rwb") : d(NULL) {tryOpen(open(device, block_size, mode));}
