...
static const CommonContainerBase container_base_genericlist_recipe_ = {
    ...
    .collection_create.list = (CollectionCreateList) genericlist_create,
    ...
    .collection_insert.list.move = (CollectionListInsertMove) genericlist_insert_move_iterator,
    .collection_insert.list.copy = (CollectionListInsertCopy) genericlist_insert_copy_iterator,
...
static const CommonContainerBase container_base_genericmap_recipe_ = {
    ...
    .parse = NULL,
    .serialize = (Serializer) io_serialize_utf8,
    .collection_create.key_value = (CollectionCreateKeyValue) genericmap_create,
...
static int genericset_collection_insert_copy(GenericSet set, const void *item, Iterator it) {
    UNUSED(it)

    return genericset_add(set, item);
}
...
static const CommonContainerBase container_base_genericset_recipe_ = {
    ...
    .parse = NULL,
    .serialize = (Serializer) io_serialize_utf8,
    .collection_create.list = (CollectionCreateList) genericset_create,
...
static int genericlinkedlist_collection_insert_move(GenericLinkedList list, void *item, Iterator it) {
    return genericlinkedlist_insert_move(list, item, genericlinkedlist_previous(list, it));
}

static int genericlinkedlist_collection_insert_copy(GenericLinkedList list, const void *item, Iterator it) {
    return genericlinkedlist_insert(list, item, genericlinkedlist_previous(list, it));
}
...
static const CommonContainerBase container_base_genericlinkedlist_recipe_ = {
    ...
    .parse = NULL,
    .serialize = (Serializer) io_serialize_utf8,
    .collection_create.list = (CollectionCreateList) genericlinkedlist_create,
    ...
    .collection_insert.list.move = (CollectionListInsertMove) genericlinkedlist_collection_insert_move,
    .collection_insert.list.copy = (CollectionListInsertCopy) genericlinkedlist_collection_insert_copy,
